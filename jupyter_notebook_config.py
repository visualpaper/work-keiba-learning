...
#  Default: ''
c.NotebookApp.notebook_dir = 'C:\\umejima\\work\\visualpaper\\keiba\\keiba-learning\\'
...
#  Choices: any of ['sha3_384', 'md5', 'blake2s', 'sha1', 'sha224', 'sha3_512', 'sha3_256', 'sha256', 'sha3_224', 'sha384', 'sha512', 'blake2b']
#  Default: 'sha256'
